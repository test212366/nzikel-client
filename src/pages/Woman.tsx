...
const localTemp:IBasketItem[] = [
	{
		...
		price: 63,
		sizes: [],
		subTitle: 'FREE RUN 3.0',
		title: 'NIKE 1',
		titleTwoSpan: 'FREE',
		heightIMG: '430px',
		classIMG: 'nikeWom',
		url: 'https://res.cloudinary.com/dnurycr3q/image/upload/v1657191999/oneWomen_clqf0j.png',
		sourseURL: 'https://stockx.imgix.net/Nike%20Free-Run-3-V4-Deep-Royal-Blue-Pink-W.png'
	},
	{
		colors: [],
		description: 'The model provides excellent cushioning.',
		...
		sizes: [],
		classIMG: 'nikeWomRM',
		subTitle: 'RN Flyknit W',
		title: 'NIKE 2',
		titleTwoSpan: 'Free',
		heightIMG: '900px',
		url: 'https://res.cloudinary.com/dnurycr3q/image/upload/v1657191999/twoWomen_dw37gc.png',
		sourseURL: 'https://www.sportkult.ru/res/shop/goods/831070_8162_501_single_.jpeg'
	},
	{
		colors: [],
		description: 'The model provides excellent cushioning.',
		price: 124,
		sizes: [],
		subTitle: 'HTPERDUNK X',
		title: 'NIKE 3',
		titleTwoSpan: 'X',
		classIMG: 'nikeWomVio',
		heightIMG: '700px',
		url: 'https://res.cloudinary.com/dnurycr3q/image/upload/v1657191999/four_mxonzs.png',
		sourseURL: 'https://media.alltricks.com/hd/11799525d26f0e8ec8507.56625466.jpg'
	...
	},
	{
		...
		sourseURL: 'https://www.runnerinn.com/f/13624/136243352/nike-free-rn-flyknit.jpg'
	}
]
